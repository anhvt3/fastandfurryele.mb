...
export const sampleQuestions: Question[] = [
  {
    ...
    type: "text",
    answers: ["Đoạn văn nói về phương tiện công cộng, ưu điểm và nhược điểm. Câu trước câu hỏi 5: "During rush hour, buses and trains can become extremely crowded,", "Delays aĐoạn văn nói về phương tiện công cộng, ưu điểm và nhược điểm. Câu trước câu hỏi 5: "During rush hour, buses and trains can become extremely crowded,nd waiting", "Expensive tickets", "Long distances"],
    correctIndex: 1,
  },
  {
    id: 2,
