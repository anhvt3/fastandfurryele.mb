...
const RaceTrack = ({ playerPosition, bot1Position, bot2Position, isJumping }: RaceTrackProps) => {
  ...
  return (
    <div className="relative w-full h-[150px] mt-[-50px] overflow-hidden flex-shrink-0 pointer-events-none">
...
        }
      ...
      <div
        className="absolute"
        style={{ left: `${finishLine}%`, transform: "translateX(-50%)", bottom: "-20px", zIndex: 25 }}
      >
