...
export const UI_CONFIG = {
  ...
  questionBox: {
    ...
    innerPaddingTop: 104, // pixels - top padding inside frame
    innerPaddingBottom: 6, // pixels - bottom padding inside frame
  ...
  answerButtons: {
    ...
    buttonGap: 10, // pixels - gap between answer buttons (gap-1)
